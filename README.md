...
```bash
wget https://github.com/kumarsatish23/Ghadiyal/blob/main/releases/latest/download/ghadiyal-plugin-1.0.0.zip
```
...
1. Download the plugin zip file from the [Download](https://github.com/kumarsatish23/Ghadiyal/blob/main/releases/latest/download/ghadiyal-plugin-1.0.0.zip) section
